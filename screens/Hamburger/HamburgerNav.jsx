...
const HamburgerNav = () =>{
    ...
    return(
        <View className="flex flex-row pt-14 justify-around bg-black ">
            <Container>
                <MotiButton className="justify-center items-center mt-[9.3px]" onPress={() => navigation.navigate('HomeScreen')}>
                    <HomeIcon />
                </MotiButton>
            </Container>
            <MotiButton className="justify-start bg-black pt-2">
                <Text className="text-violet-300 text-xl font-black font-sans tracking-[1.7px] px-8 pb-3">Explore</Text>
            </MotiButton>
            <Container>
                <MotiButton className="justify-center items-center mt-[13px]" onPress={() => navigation.navigate('NotificationScreen')}>
